...
export function PortfolioSection() {
  const projects = [
    {
      title: "Customizable EHR system",
      description: "EHR System Work-in-progress. An ambitious modular EHR for mental health, enabling practitioners to custom-build their platform and pay only for essential features, slashing overhead while simplifying clinician workflow.",
      tag: "Full Stack",
    ...
    {
      title: "Hear-here",
      description: "AI-powered clinical documentation assistant designed to automate real-time note-taking, enabling practitioners to wholly focus on connecting with the client.",
      tag: "AI Engineering",
    ...
    <section className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 id="projects" className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
